import Customers.NguoiThuePhong;
import Customers.ThuePhong;
import Hotels.Phong;
...
public class App implements Constants {
	...
	public void chen_ptu() {
		...
		while (true) {
			...
			// Check if there is a room that has the same ID.
			for (int i = 0; i < k; i++)
		...
		try {
			...
			if (dsp[0] == null)
				...
				while (true) {
					...
					// Find based on the number of passengers.
					...
					// If the input doesn't match any finding case.
					else
	...
	public static void main(String[] args) {
		...
		do {
			try {
				...
				default:
					System.out.println("Gia tri nhap vao ko ton tai trong danh sach chuc nang.");
					break;
				}
