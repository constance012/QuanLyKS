...
public class Phong implements Constants {
	...
	public Phong(int ID, String tenLoaiPhong, String tenPhong, String tinhTrang, int soNguoi) {
		...
		if (tenLoaiPhong.equalsIgnoreCase("thuong") || tenLoaiPhong.equalsIgnoreCase("dac biet")
				|| tenLoaiPhong.equalsIgnoreCase("vip"))
	...
	public void xuat() {
		System.out.printf(
				"| Loai phong: %10s | Ma phong: %d | Ten phong: %20s | Tinh trang: %15s | So nguoi: %d | Gia ca: %5.1f VND\n",
