...
public class ChiTietHoaDon extends HoaDon implements Constants{
    ...
    public ChiTietHoaDon(int maKH, String tenKH, String diaChi, String email, String soDT, String soCMND, int soNg, int soNgayThue, int maPhg, double soTienThuePhong, double soTienKhachTra, int maHoaDon) {
        super(maHoaDon);
