...
public class ChiTietHoaDon extends HoaDon implements Constants {
	...
	private int soNgayThue, soNg, maPhg, maKH;
	...
	public ChiTietHoaDon(int maKH, String tenKH, String diaChi, String email, String soDT, String soCMND, int soNg,
			int soNgayThue, int maPhg, double soTienThuePhong, double soTienKhachTra, int maHoaDon) {
		super(maHoaDon);
	...
	public void setSoTienKhachTra() {
		...
		while (true) {
			...
			if (soTienKhachTra <= 0)
				...
				System.out.println("So tien nho hon so tien thue phong, vui long nhap lai:");
			else {
				this.soTienKhachTra = soTienKhachTra;
				break;
			}
	...
	public void inHoaDon() {
		...
		System.out.printf("Ho ten khach hang: %s\n", tenKH);
		System.out.printf("Dia chi: %s\n", diaChi);
		System.out.printf("Email: %s\n", email);
		System.out.printf("So dien thoai: %s\n", soDT);
		System.out.printf("So CMND: %s\n", soCMND);
		...
		if (ATM) {
			...
			System.out.printf("So the: %s\n", card.getSoThe());
			System.out.printf("Loai the: %s\n", card.getLoaiThe());
			System.out.printf("Ho ten chu the: %s\n", card.getTenChuThe());
			...
			if (input.equalsIgnoreCase("atm") || input.equalsIgnoreCase("cash"))
				...
				if (input.equalsIgnoreCase("atm")) {
					...
					// If denied access.
						...
						System.out.println("Tu choi truy cap vao the, giao dich that bai.");
						break;
					}
				}
